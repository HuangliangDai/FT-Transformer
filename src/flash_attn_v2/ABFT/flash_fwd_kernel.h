...
#pragma unroll
    ...
    acc_o(0,0,0) = (checksum_o(0,0,0) > 1 || checksum_o(0,0,0) < -1) ? 1.0 : acc_o(0,0,0); // for test only
...
#pragma unroll
    ...
    acc_o(0,0,0) = (checksum_o2(0,0,0) > 1 || checksum_o2(0,0,0) < -1) ? 1.0 : acc_o(0,0,0); // for test only
